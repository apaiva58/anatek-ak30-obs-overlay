...
Python bridge between Anatec AK30 scoreboard controller and OBS Studio for live basketball overlay. Reads serial data via USB, serves a web overlay, feeds into OBS Browser Source. Developed by Almere Pioneers basketball club.
